    ...
    <div className="bg-[#eef2f6]">
      <section className="bg-[#060f24] text-white py-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8 text-center">
          <span className="text-yellow-400 text-xs font-bold uppercase tracking-[0.2em]">Contact</span>
        ...
        <div className="grid lg:grid-cols-[1fr_400px] gap-12">
            ...
            {sent ? (
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="mt-6 text-sm font-semibold text-yellow-500 hover:text-yellow-600"
                >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full border border-slate-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400/40 transition resize-none"
                    />
                  </div>
                </div>
                <label className="flex items-start gap-3 mb-6 cursor-pointer">
                  <input
                    ...
                    className="mt-1 rounded border-slate-300 text-yellow-500 focus:ring-yellow-400"
                  />
                ...
                <button
                  ...
                  className="bg-yellow-400 text-[#060f24] px-6 py-3 rounded-lg font-bold text-sm hover:bg-yellow-300 transition disabled:opacity-50 flex items-center gap-2"
                >
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">contact@novahexa.move</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden h-48">
              <iframe
                title="Localisation Novahexa Move"
